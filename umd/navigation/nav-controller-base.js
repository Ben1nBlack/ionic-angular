...
(function (factory) {
    ...
    var NavControllerBase = (function (_super) {
        ...
        NavControllerBase.prototype.setRoot = function (pageOrViewCtrl, params, opts, done) {
            var /** @type {?} */ viewControllers = [nav_util_1.convertToView(this._linker, pageOrViewCtrl, params)];
        ...
        NavControllerBase.prototype.setPages = function (pages, opts, done) {
            var /** @type {?} */ viewControllers = nav_util_1.convertToViews(this._linker, pages);
            return this._setPages(viewControllers, opts, done);
        };
        /**
        ...
        NavControllerBase.prototype._queueTrns = function (ti, done) {
            ...
            ti.reject = function (rejectReason, transition) {
                ...
                while (transition) {
                    ...
                    if (enteringView && (enteringView._state === nav_util_1.ViewState.ATTACHED)) {
        ...
        NavControllerBase.prototype._nextTrns = function () {
            ...
            if (insertViews) {
                for (var /** @type {?} */ i = 0; i < insertViews.length; i++) {
                    ...
                    if (nav && nav !== this || insertViews[i]._state === nav_util_1.ViewState.DESTROYED) {
            ...
            if (enteringView && enteringView._state === nav_util_1.ViewState.NEW) {
        ...
        NavControllerBase.prototype._viewInit = function (enteringView) {
            ...
            var /** @type {?} */ componentFactory = this._cfr.resolveComponentFactory(enteringView.component);
        ...
        NavControllerBase.prototype._viewAttachToDOM = function (view, componentRef, viewport) {
            ...
            view._state = nav_util_1.ViewState.ATTACHED;
            if (view._cssClass) {
