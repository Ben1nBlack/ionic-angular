...
export class NavControllerBase extends Ion {
    ...
    setRoot(pageOrViewCtrl, params, opts, done) {
        const /** @type {?} */ viewControllers = [convertToView(this._linker, pageOrViewCtrl, params)];
    ...
    setPages(pages, opts, done) {
        const /** @type {?} */ viewControllers = convertToViews(this._linker, pages);
        return this._setPages(viewControllers, opts, done);
    }
    /**
    ...
    _viewInit(enteringView) {
        ...
        const /** @type {?} */ componentFactory = this._cfr.resolveComponentFactory(enteringView.component);
